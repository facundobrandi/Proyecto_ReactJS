...
const products = [
  { title:'hamburguesas', category: 'carne', description:'string', price: 100, pictureUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/62/NCI_Visuals_Food_Hamburger.jpg', stock: 10},
